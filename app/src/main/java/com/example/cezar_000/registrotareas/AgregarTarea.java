    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonFecha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AgregarTarea.this, date, calendarDate.get(calendarDate.YEAR),
        ...
        buttonHora.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new TimePickerDialog(AgregarTarea.this, time, calendarTime.get(calendarTime.HOUR),
